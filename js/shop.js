							      ...
							      + '<div class=\x22modal-body\x22>'
							      	+ '<form action=\x22php/updatecart.php\x22 method=\x22POST\x22>'
							      		...
							      		+ 'Size <select name=\x22size\x22>'
							      			...
							      			+ '<option value=\x22' + medprice.toFixed(2) + '\x22> Medium $' + medprice.toFixed(2)
							      			+ '<option value=\x22' + largeprice.toFixed(2) + '\x22> Large $' + largeprice.toFixed(2)
							      		+ '</select>'
							      		+ 'Quantity <select name=\x22quantity\x22>'
							      			+ '<option value=\x221\x22> 1'
							      			+ '<option value=\x222\x22> 2'
							      			+ '<option value=\x223\x22> 3'
							      			+ '<option value=\x224\x22> 4'
							      			+ '<option value=\x225\x22> 5'
							      			+ '<option value=\x226\x22> 6'
							      			+ '<option value=\x227\x22> 7'
							      			+ '<option value=\x228\x22> 8'
							      			+ '<option value=\x229\x22> 9'
							      			+ '<option value=\x2210\x22> 10'
							      		+ '</select>'
